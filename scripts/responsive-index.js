...
function initInfoMap() {
    infoMap = [];
    infoMap.push({
        "data": "<h3>January 21, 2020 — First confirmed case in the United States</h3><p align='left'>CDC Confirms First US Coronavirus Case: A Washington state resident becomes the first person in the United States with a confirmed case of the 2019 novel coronavirus, having returned from Wuhan on January 15. The CDC soon after deploys a team to help with the investigation, including potential use of contact tracing.</p>" +
            "<h3>February 2, 2020 — Global Air Travel Is Restricted</h3><p align='left'>The new U.S. travel rules, prohibit foreigners who have been in China in the last 14 days from entering the United States. Exemptions include whether they are an immediate family member of a U.S. citizen or a permanent resident. The U.S. is imposing a 14-day quarantine on citizens who have visited China’s Hubei province — where Wuhan, the epicenter of the virus, is located.</p>"
    });
    infoMap.push({
        "data": "<h3>March 1, 2020 — 1st death reported in United States</h3><p align='left'>The first COVID-19 death is reported in Washington state, after a man with no travel history to China dies on Feb. 28 at Evergreen Health Medical Center in Kirkland, Washington.Two deaths that occurred Feb. 26 at a nearby nursing home would later be recorded as the first COVID-19 deaths to occur in the United States. Later still, a death in Santa Clara, California, on Feb. 6 would be deemed the country's first COVID-19 fatality after an April autopsy.</p>" +
            "<h3>March 3, 2020 — U.S. officials approved widespread testing</h3><p align='left'>The C.D.C. lifted all federal restrictions on testing for the coronavirus on March 3, according to Vice President Mike Pence. The news came after the C.D.C.’s first attempt to produce a diagnostic test kit fell flat. By this point, the coronavirus had infected more than 90,000 around the globe and killed about 3,000, according to the W.H.O.</p>"
    });
    infoMap.push({
        "data": "<h3>March 13, 2020 — President Trump declares national emergency</h3><p align='left'>President Donald Trump <a href='https://www.nytimes.com/2020/03/13/world/coronavirus-news-live-updates.html#link-37509802'>declares a U.S. national emergency</a>, which he says will open up $50 billion in federal funding to fight COVID-19.</p>" +
            "<h3>March 22, 2020 — New York Is Now an Epicenter of the Pandemic</h3><p align='left'>New York now accounts for roughly 5 percent of the world’s confirmed cases, making it an epicenter of the pandemic and increasing pressure on officials to take more drastic measures. <br/>The first and most obvious explanation for the severity of the area's outbreak is that New York is the largest and most densely populated city in the US, and coronavirus tends to spread in dense places.<br/>" +
            "<i><b>That spatial closeness makes us vulnerable,</b></i> — New York Gov. Andrew Cuomo said Wednesday.</p>"
    });
    infoMap.push({
        "data": "<h3>April 16, 2020 — U.S. Coronavirus Death Toll Hits New Single-Day Record</h3><p align='left'>The U.S. coronavirus death toll reached 4,928 in 24 hours on Thursday, nearly doubling the previous single-day record, according to data compiled by Johns Hopkins University.</p>" +
            "<h3>April 21, 2020 — Officials discovered earlier known COVID deaths in California</h3><p align='left'>Officials in Santa Clara County, Calif., announced that two residents there died of the coronavirus on Feb. 6 and Feb. 17, making them the <a href='https://www.nytimes.com/2020/04/22/us/coronavirus-first-united-states-death.html'>earliest known victims</a> of the pandemic in the United States. The new information, gained from autopsies of the residents, moved the timeline of the virus’s spread in country weeks earlier than previously understood.</p>"
    });
    infoMap.push({
        "data": "<h3>June 1, 2020 — Lift of Stay-at-home order</h3><p align='left'>Multiple states have lifted the stay-at-home order; outdoor gatherings of up to a hundred are allowed. Meanwhile, the total number of cases continued to increase.</p>" +
            "<h3>June 4, 2020 — Coronavirus tore into regions previously spared</h3><p align='left'>The number of known cases across the globe grew faster than ever, with more than 100,000 new infections a day. </p>" +
            "<h3>June 11, 2020 — 2 Million COVID Cases</h3><p align='left'>The United States has passed 2 million confirmed cases of the virus, according to Johns Hopkins.</p>"
    });
